...
$('.single-item').slick();
 ...
 <div class="large-12 columns text-center">
    ...
    <center><h3>ALL WRITE FILES  </h3>
      <table>
          <tr><th>EMAIL</th><th>FILE ID</th><th>BLOCK</th><th>WRITE TIME(MS)</th>
       </tr>
      <%try{
      String query="select * from blockupdate1 bu,updateblock2 up where bu.email='"+email+"' and up.email='"+email+"'";    
        ...
        <tr>
            ...
            <td><textarea cols="35" rows="10"><%=rr.getString("bu.block")%></textarea></td> 
             <td><%=rr.getString("bu.wtime")%>ms</td> 
        </tr>
        <tr>
            <td><%=rr.getString("up.email")%></td>
            <td><%=rr.getString("up.fid")%></td>
            <td><textarea cols="35" rows="10"><%=rr.getString("up.block")%></textarea></td> 
             <td><%=rr.getString("up.wtime")%>ms</td> 
        </tr>
