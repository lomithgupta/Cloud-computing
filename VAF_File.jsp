...
$('.single-item').slick();
 ...
 <%String email=(String)session.getAttribute("email");%>
  ...
  <center>
    <table>
        <tr><th>OWNER</th><th>FILE ID</th><th>FILE NAME</th><th>FILE SIZE</th><th>WRITE PERMISSION</th>
      ...
      String query="select * from files";    
        ...
        <tr>
            ...
            <td><%=rr.getString("fname")%></td>
             ...
             <td><a href="Write_Request.jsp?fid=<%=rr.getString("fid")%>&owner=<%=rr.getString("owner")%>">Write Permission</a></td>
             <td><a href="Read_Request.jsp?fid=<%=rr.getString("fid")%>&owner=<%=rr.getString("owner")%>">Read Permission</a></td>
        </tr>
